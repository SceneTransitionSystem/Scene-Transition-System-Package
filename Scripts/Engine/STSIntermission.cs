...
namespace SceneTransitionSystem
{
    ...
    {
        public static List<STSSceneManagerInterface> STSSceneManagerInterfaceList = new List<STSSceneManagerInterface>{STSSceneManager.Singleton()};
        /// <summary>
        ...
        /// </value>
        public bool IsReadyToActivate { get; set; } = false;
        ...
        {
            foreach (STSSceneManagerInterface tSingleton in STSSceneManagerInterfaceList)
            {
                tSingleton.FinishStandBy();
            }
            //.FinishStandBy();
        }
    }
